...
sdg_pillars: ["People", "Peace"]
sdg_impact: "Improves citizen access to administrative services and reduces bureaucratic barriers for vulnerable populations"
...
<div style={{marginBottom: '1rem'}}>
  <SDGBadge pillar="People" />
  <SDGBadge pillar="Peace" />
</div>

**SDG Impact:** Improves citizen access to administrative services and reduces bureaucratic barriers for vulnerable populations
