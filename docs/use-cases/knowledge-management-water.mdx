...
sdg_pillars: ["Partnership", "Planet"]
sdg_impact: "Facilitates knowledge sharing and capacity building for sustainable technical solutions in environmental sectors"
stakeholders: ["Technical Professional", "Knowledge Worker", "Researcher", "Project Manager"]
ai_techniques: ["Semantic Search", "RAG", "Natural Language Processing", "Information Retrieval"]
---
...
<div style={{marginBottom: '1rem'}}>
  ...
  <SDGBadge pillar="Planet" />
</div>

**SDG Impact:** Facilitates knowledge sharing and capacity building for sustainable technical solutions in environmental sectors
